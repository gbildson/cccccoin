...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cccccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cccccoin.com", "seed.cccccoin.com"},
    {"ccccchain.info", "seed.ccccchain.info"},
    {"mophides.com", "seed.mophides.com"},
    {"dglibrary.org", "seed.dglibrary.org"},
//    {"cccccoinpool.org", "dnsseed.cccccoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cccccoin is probably already running."), addrBind.ToString().c_str());
        else
